...
the sections: \hyperref[sec:org4bffa7b]{Cache memory}, \hyperref[sec:org4b9e5fe]{Memory bus} and \hyperref[sec:org7d76830]{Main memory}, we explain more in
...
\label{sec:org9e1bf84}

\begin{enumerate}
\item Consistency memory model
\label{sec:org30f59a5}
...
\label{sec:org39b2fa6}



\chapter{Some Foundations}
\label{sec:orgb620f59}

\section{Cache memory}
\label{sec:orga11a0ef}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org595234b}


\item Cache coherence protocols
\label{sec:orgbadc8f8}



\begin{enumerate}
\item MESI
\label{sec:org5d06ec5}


\item MOESI
\label{sec:org257a292}
\end{enumerate}


\item Store Buffers
\label{sec:org6ffeeeb}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:org9edbd84}


\section{Memory Barriers}
\label{sec:org0c8bcf4}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org7f76010}


\item Memory Fences
\label{sec:org2f83aa0}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:orge759fda}


\section{Bibliography}
\label{sec:org96fa398}
...
\label{sec:org32e0f78}

\chapter{Introduction}
\label{sec:orgb5cba99}
...
\part{Work-stealing}
\label{sec:org6c3b0e9}

\part{Other links}
\label{sec:orgd42b2da}

\chapter{Youtube videos}
\label{sec:org1bd37e4}
...
\label{sec:org0483a8f}

\chapter{Concurrent computing}
\label{sec:orgfd97d90}

\section{Work-Stealing}
\label{sec:orge5a7409}

\section{Article}
\label{sec:org8862538}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:orgb9dfe6d}

\begin{enumerate}
\item Experiments C++
\label{sec:org204ae34}
\begin{enumerate}
\item What to use?
\label{sec:org7129c41}
...
\section{Links}
\label{sec:org864a7d2}
\begin{enumerate}
\item Philosophy
\label{sec:org92222ae}
...
\label{sec:org384c8db}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgd88a104}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org6879ce7}

\section{Git}
\label{sec:org839ff3f}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org8bf3802}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:orgd59e4cd}

\section{Temario tentativo}
\label{sec:org6e0877e}
...
\label{sec:org0b59eee}

\begin{enumerate}
\item Diseño experimental
\label{sec:org2a502dc}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org1fafdeb}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org837b298}
...
\label{sec:orgc180e0e}


\begin{enumerate}
\item Data Science
\label{sec:orgc6817ef}
...
\label{sec:orgfe9430b}

\item Main Concepts
\label{sec:org94f4aca}

\item Match Between Statistic and Data Science
\label{sec:org031c879}
\end{enumerate}
