...
the sections: \hyperref[sec:org2b586ee]{Cache memory}, \hyperref[sec:orgcf4fbf9]{Memory bus} and \hyperref[sec:orgc4f50a0]{Main memory}, we explain more in
...
\label{sec:orgcb9adfb}

\begin{enumerate}
\item Consistency memory model
\label{sec:org366a72c}
...
\section{{\bfseries\sffamily TODO} Data-Structures}
\label{sec:org119acdb}

\subsection{Queues}
\label{sec:org056fb61}

\subsection{Stacks}
\label{sec:org63eedcb}


\section{{\bfseries\sffamily TODO} Some Hardware Foundations}
\label{sec:org0f1e01e}

\subsection{Cache memory}
\label{sec:org8933720}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org12c21b6}


\item Cache coherence protocols
\label{sec:org71573db}



\begin{enumerate}
\item MESI
\label{sec:orgf2bed00}


\item MOESI
\label{sec:org258e798}
\end{enumerate}


\item Store Buffers
\label{sec:orgcf8974f}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:orgdaef395}

\subsection{Memory Barriers}
\label{sec:orga7146dd}

\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org76bea50}

\item Memory Fences
\label{sec:org3295285}
\end{enumerate}

\subsection{Read-Modify-Write Operations}
\label{sec:org0e41a73}

\subsection{Bibliography}
\label{sec:orgdab0851}
...
\label{sec:org9db9414}

\subsection{LL/IC Experiments}
\label{sec:org6783ecc}
...
\label{sec:orga6b2705}


\chapter{Bibliography}
\label{sec:org92fb082}
