...
\part{Introduction}
\label{sec:orga5ff916}

\chapter{About Concurrent Computing}
\label{sec:org45f6ea3}
...
\label{sec:org2e76b2f}

\section{Organization}
\label{sec:org988e344}

\chapter{Preliminaries}
\label{sec:org7d942c4}


\section{Mathematical model}
\label{sec:org2c99500}


\section{Realistic model of computation}
\label{sec:org74c8c32}
...
the sections: \hyperref[sec:org22dbe46]{Cache memory}, \hyperref[sec:org54eab37]{Memory bus} and \hyperref[sec:orgd64036e]{Main memory}, we explain more in
...
\label{sec:org5f54488}

\begin{enumerate}
\item Consistency memory model
\label{sec:orgce92109}
...
\section{Model}
\label{sec:orgace8972}

\section{Known algorithms}
\label{sec:orgee58f41}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:org11565ac}



\chapter{Data-Structures}
\label{sec:org638eec8}

\section{Queues}
\label{sec:org45ebd01}

\section{Stacks}
\label{sec:org2666542}

\chapter{Some Hardware Foundations}
\label{sec:org40cf7cc}

\section{Cache memory}
\label{sec:org09268fb}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orgecb029e}


\item Cache coherence protocols
\label{sec:orgfafc37a}



\begin{enumerate}
\item MESI
\label{sec:org882e8e0}


\item MOESI
\label{sec:orgc305a33}
\end{enumerate}


\item Store Buffers
\label{sec:org581452d}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:org6163167}


\section{Memory Barriers}
\label{sec:orgf5a9e02}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:orgffa320f}


\item Memory Fences
\label{sec:orgd94c4b2}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org695fce9}


\section{Bibliography}
\label{sec:orgc742402}
...
\label{sec:orga12980e}

\chapter{Introduction}
\label{sec:orgca3f0db}
...
\part{Work-stealing}
\label{sec:orga2b8085}




\part{Modular Basket Queues}
\label{sec:orge46dacb}

\chapter{Measuring Performance}
\label{sec:orgc26aeb7}

\section{Introduction}
\label{sec:orgc95ae50}
...
\section{Average performance and variability}
\label{sec:orge25e6d9}
...
\section{Errors in experimental measurements}
\label{sec:org8aa9c11}
...
\section{Measurement tools and techniques.}
\label{sec:orgcbb35b1}
...
\section{The design of experiments}
\label{sec:org8b22171}
...
\label{sec:org95da756}

\chapter{Concurrent computing}
\label{sec:org2b3a3b4}

\section{Work-Stealing}
\label{sec:org94dabd0}

\section{Article}
\label{sec:orgc943107}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org2140ee0}

\begin{enumerate}
\item Experiments C++
\label{sec:org203e919}
\begin{enumerate}
\item What to use?
\label{sec:org734e226}
...
\item Model
\label{sec:orgaf28ab7}

\item Technology to use
\label{sec:org374354a}
...
\section{Links}
\label{sec:org8625d8c}
\begin{enumerate}
\item Philosophy
\label{sec:org0d6cb73}
...
\label{sec:org950780f}
\begin{enumerate}
\item C/C++/Java
\label{sec:org06e61b4}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org38ed093}

\section{Git}
\label{sec:org1a65f2b}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org08a5ad5}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org6b5417f}

\section{Temario tentativo}
\label{sec:orgc07fada}
...
\label{sec:orgfedb424}

\begin{enumerate}
\item Diseño experimental
\label{sec:orga2d56a5}
\begin{itemize}
...
\label{sec:org17c4f98}


\begin{enumerate}
\item Data Science
\label{sec:orgff9d483}
...
\label{sec:org6337d14}

\item Main Concepts
\label{sec:org94c83fb}

\item Match Between Statistic and Data Science
\label{sec:orgdc42750}
\end{enumerate}
...
\label{sec:org9532e78}
\begin{enumerate}
\item Main ideas
\label{sec:orge7915d7}
