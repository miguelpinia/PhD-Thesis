...
\label{sec:orgcc73003}

\section{About Concurrent Computing}
\label{sec:orgedb68ee}
...
\label{sec:org56d6df7}

\subsection{Organization}
\label{sec:orgd8f3574}


\section{Preliminaries}
\label{sec:org4cf3aa3}


\subsection{Mathematical model}
\label{sec:org8b13522}


\subsection{Realistic model of computation}
\label{sec:org3f45831}
...
the sections: \hyperref[sec:org491da91]{Cache memory}, \hyperref[sec:orge41923c]{Memory bus} and \hyperref[sec:orgf942c91]{Main memory}, we explain more in
...
\label{sec:org06d2bc0}

\begin{enumerate}
\item Consistency memory model
\label{sec:orgda57001}
...
\subsection{Model}
\label{sec:org7377f6f}

\subsection{Known algorithms}
\label{sec:orgd7c5621}

\subsection{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:org9847c1e}



\section{Data-Structures}
\label{sec:orgc249163}

\subsection{Queues}
\label{sec:orgfe57977}

\subsection{Stacks}
\label{sec:orgabd7b73}


\section{Some Hardware Foundations}
\label{sec:org4dfd162}

\subsection{Cache memory}
\label{sec:org7d4d6c8}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org15413c0}


\item Cache coherence protocols
\label{sec:org3ff3f9c}



\begin{enumerate}
\item MESI
\label{sec:orgbbc60ff}


\item MOESI
\label{sec:org4808846}
\end{enumerate}


\item Store Buffers
\label{sec:org5d2728a}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:org671acd4}


\subsection{Memory Barriers}
\label{sec:orgb7040f0}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org6a07c2a}


\item Memory Fences
\label{sec:org5ff071d}
\end{enumerate}


\subsection{Read-Modify-Write Operations}
\label{sec:orgac9f010}


\subsection{Bibliography}
\label{sec:org516c429}
...
\label{sec:org3008c3f}

\section{Introduction}
\label{sec:orgd45b4a1}
...
\label{sec:org8ebb479}


\chapter{Modular Basket Queues}
\label{sec:org854dcc7}

\section{Measuring Performance}
\label{sec:orgbdf3d4d}

\subsection{Introduction}
\label{sec:orge8a97f3}
...
\label{sec:org665643b}


\section{Clojure for data-science}
\label{sec:org3f67e8f}
...
\label{sec:org7aaf395}

\section{1.1 Threads}
\label{sec:orge6baeba}
...
\chapter{Other links}
\label{sec:org34670e0}

\section{Youtube videos}
\label{sec:org07c34d2}
...
\chapter{Notes}
\label{sec:org8035e54}

\section{Concurrent computing}
\label{sec:org2518503}

\subsection{Work-Stealing}
\label{sec:orgb4f4a8e}

\subsection{Article}
\label{sec:orgbedcdfd}

\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org3b0e57e}

\begin{enumerate}
\item Experiments C++
\label{sec:orgb303a94}

\begin{enumerate}
\item What to use?
\label{sec:org9e660ec}
...
\item Model
\label{sec:orgf367c6a}

\item Technology to use
\label{sec:org3e13399}
...
\subsection{Links}
\label{sec:org1f8d999}
\begin{enumerate}
\item Philosophy
\label{sec:orga01f19f}
...
\label{sec:org817ff25}
\begin{enumerate}
\item C/C++/Java
\label{sec:org9fda9b0}
\begin{itemize}
...
\section{Notes}
\label{sec:orgbc12a8f}

\subsection{Git}
\label{sec:org046b8c7}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org7e675be}
\begin{itemize}
...
\section{Statistics}
\label{sec:org925bf8c}

\subsection{Temario tentativo}
\label{sec:org54f7f70}
...
\label{sec:orgce0abbe}

\begin{enumerate}
\item Diseño experimental
\label{sec:org029c916}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org81270f1}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org76f8e09}
...
\label{sec:org1655ae3}


\begin{enumerate}
\item Data Science
\label{sec:org9294402}
...
\label{sec:org1318a4f}

\item Main Concepts
\label{sec:orgf18523d}

\item Match Between Statistic and Data Science
\label{sec:orgb6cd8b4}
\end{enumerate}
...
\label{sec:org254001a}
\begin{enumerate}
\item Main ideas
\label{sec:org90fa56e}
