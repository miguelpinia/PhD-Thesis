...
\label{sec:org89e1ba7}

\section{About Concurrent Computing}
\label{sec:orgc1515b7}
...
\label{sec:org5a10186}

\subsection{Organization}
\label{sec:org15a5904}


\section{Preliminaries}
\label{sec:org264be44}


\subsection{Mathematical model}
\label{sec:org9ee6ed4}


\subsection{Realistic model of computation}
\label{sec:org00c0b65}
...
the sections: \hyperref[sec:orgcab7f89]{Cache memory}, \hyperref[sec:org1777665]{Memory bus} and \hyperref[sec:org923d2fa]{Main memory}, we explain more in
...
\label{sec:org8732d5c}

\begin{enumerate}
\item Consistency memory model
\label{sec:org965083b}
...
\subsection{Model}
\label{sec:org19a924a}

\subsection{Known algorithms}
\label{sec:orgc9e1da8}

\subsection{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orge95d423}



\section{Data-Structures}
\label{sec:org6359dd0}

\subsection{Queues}
\label{sec:orgd92fdd2}

\subsection{Stacks}
\label{sec:org16855ca}


\section{Some Hardware Foundations}
\label{sec:org0744048}

\subsection{Cache memory}
\label{sec:orgcc0a401}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org48adc41}


\item Cache coherence protocols
\label{sec:org14372fb}



\begin{enumerate}
\item MESI
\label{sec:org7599432}


\item MOESI
\label{sec:orga46ebef}
\end{enumerate}


\item Store Buffers
\label{sec:org28a5b59}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:org78add48}


\subsection{Memory Barriers}
\label{sec:orgf1c7ec7}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:orgffca769}


\item Memory Fences
\label{sec:org8ae4123}
\end{enumerate}


\subsection{Read-Modify-Write Operations}
\label{sec:orgda08d79}


\subsection{Bibliography}
\label{sec:orgf3574f8}
...
\label{sec:org89b1600}

\section{Introduction}
\label{sec:org9e9adda}
...
\label{sec:org8ec8ad9}


\chapter{Modular Basket Queues}
\label{sec:org6836216}

\section{Measuring Performance}
\label{sec:org811c9f1}

\subsection{Introduction}
\label{sec:org0f896ec}
...
\label{sec:org5eaa579}


\section{Clojure for data-science}
\label{sec:org09eb998}
...
\label{sec:org7b015bd}

\section{1.1 Threads}
\label{sec:org6b82a2e}
...
\chapter{Other links}
\label{sec:org7d186e5}

\section{Youtube videos}
\label{sec:org8f4b03d}
...
\chapter{Notes}
\label{sec:org7c28037}

\section{Concurrent computing}
\label{sec:org795539e}

\subsection{Work-Stealing}
\label{sec:org289cf65}

\subsection{Article}
\label{sec:orgad204cc}

\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:orgdddca73}

\begin{enumerate}
\item Experiments C++
\label{sec:orgd9905bf}

\begin{enumerate}
\item What to use?
\label{sec:org1e3ff3b}
...
\item Model
\label{sec:org5cdb492}

\item Technology to use
\label{sec:orgd3b7215}
...
\subsection{Links}
\label{sec:org9744f85}
\begin{enumerate}
\item Philosophy
\label{sec:orgc450fc1}
...
\label{sec:org114e094}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgf6551f2}
\begin{itemize}
...
\section{Notes}
\label{sec:org5220df8}

\subsection{Git}
\label{sec:orgff6b195}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org9981cce}
\begin{itemize}
...
\section{Statistics}
\label{sec:orgc352885}

\subsection{Temario tentativo}
\label{sec:orgfe1427c}
...
\label{sec:orge9fcc5b}

\begin{enumerate}
\item Diseño experimental
\label{sec:org3b8480a}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:orgab43b76}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:orgfe0da2c}
...
\label{sec:org16d1104}


\begin{enumerate}
\item Data Science
\label{sec:orgf7c37b1}
...
\label{sec:org9042ef8}

\item Main Concepts
\label{sec:orga49016e}

\item Match Between Statistic and Data Science
\label{sec:org754f1c6}
\end{enumerate}
