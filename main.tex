...
\part{Introduction}
\label{sec:org6a92248}

\chapter{About Concurrent Computing}
\label{sec:orgf440fe0}
...
\label{sec:org16b1a10}

\section{Organization}
\label{sec:org53a4d89}

\chapter{Preliminaries}
\label{sec:org37e81e8}


\section{Mathematical model}
\label{sec:org358c283}


\section{Realistic model of computation}
\label{sec:orgbef3095}
...
the sections: \hyperref[sec:orgf88e3d1]{Cache memory}, \hyperref[sec:orgf7efd3c]{Memory bus} and \hyperref[sec:org31caece]{Main memory}, we explain more in
...
\label{sec:orga8b4e1b}

\begin{enumerate}
\item Consistency memory model
\label{sec:orgb801b9f}
...
\section{Model}
\label{sec:org90fc97f}

\section{Known algorithms}
\label{sec:orgc2559ac}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orgde33e5b}



\chapter{Data-Structures}
\label{sec:orge28283a}

\section{Queues}
\label{sec:orgd2f87fe}

\section{Stacks}
\label{sec:orga264d71}

\chapter{Some Hardware Foundations}
\label{sec:org8f40e7b}

\section{Cache memory}
\label{sec:orgec24d4b}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orgb19df8f}


\item Cache coherence protocols
\label{sec:org55d5b73}



\begin{enumerate}
\item MESI
\label{sec:org82f93c5}


\item MOESI
\label{sec:org9d6de49}
\end{enumerate}


\item Store Buffers
\label{sec:orgd4863b1}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:org6c45463}


\section{Memory Barriers}
\label{sec:org324ed5e}
...
\item Memory Fences
\label{sec:orgc453285}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org2987bbb}


\section{Bibliography}
\label{sec:org6ea34fb}
...
\label{sec:org42dbf02}

\chapter{Introduction}
\label{sec:org640c641}
...
\label{sec:org8245405}


\part{Other links}
\label{sec:org7d30b46}

\chapter{Youtube videos}
\label{sec:org649c58b}
...
\label{sec:org53caec7}

\chapter{Concurrent computing}
\label{sec:org7a31e27}

\section{Work-Stealing}
\label{sec:org2075085}

\section{Article}
\label{sec:org3af2bd5}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org995eef4}

\begin{enumerate}
\item Experiments C++
\label{sec:orgcf73be8}
\begin{enumerate}
\item What to use?
\label{sec:org4b3c0fe}
...
\item Model
\label{sec:orgd2b5b86}

\item Technology to use
\label{sec:org9bc74d7}
...
\section{Links}
\label{sec:orge2c9bb2}
\begin{enumerate}
\item Philosophy
\label{sec:org5b280e1}
...
\label{sec:orgf1e19b5}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgab82ad5}
\begin{itemize}
...
\chapter{Notes}
\label{sec:orgb2e697d}

\section{Git}
\label{sec:org7ae830d}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:orge915abb}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org150fe30}

\section{Temario tentativo}
\label{sec:orgdb9957c}
...
\label{sec:org6f90237}

\begin{enumerate}
\item Diseño experimental
\label{sec:org26afcf3}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org5d91eb3}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org1d98331}
...
\label{sec:orgb072a6c}


\begin{enumerate}
\item Data Science
\label{sec:org8247d4d}
...
\label{sec:org3d547c6}

\item Main Concepts
\label{sec:orgd9f6ebf}

\item Match Between Statistic and Data Science
\label{sec:orgfcb366b}
\end{enumerate}
...
\label{sec:orga6cf65e}
\begin{enumerate}
\item Main ideas
\label{sec:orgb6aac46}
