...
\part{Introduction}
\label{sec:orgf1a27fd}

\chapter{About Concurrent Computing}
\label{sec:org7bb87dc}
...
\label{sec:orge90a964}

\section{Organization}
\label{sec:org2f4ca7d}

\chapter{Preliminaries}
\label{sec:org12425d1}


\section{Mathematical model}
\label{sec:org28d1093}


\section{Realistic model of computation}
\label{sec:org86672e5}
...
the sections: \hyperref[sec:orgd006c22]{Cache memory}, \hyperref[sec:org7f05b7d]{Memory bus} and \hyperref[sec:org8d56495]{Main memory}, we explain more in
...
\label{sec:orgc5163db}

\begin{enumerate}
\item Consistency memory model
\label{sec:org5023750}
...
\section{Model}
\label{sec:orgdfd2bd7}

\section{Known algorithms}
\label{sec:org96ceac6}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orgabe7ceb}



\chapter{Data-Structures}
\label{sec:org074585b}

\section{Queues}
\label{sec:org6499b4a}

\section{Stacks}
\label{sec:orgf1acdc6}

\chapter{Some Hardware Foundations}
\label{sec:org8c5420f}

\section{Cache memory}
\label{sec:org5c53351}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org497f13a}


\item Cache coherence protocols
\label{sec:orgad1ff15}



\begin{enumerate}
\item MESI
\label{sec:orga887170}


\item MOESI
\label{sec:orge837efe}
\end{enumerate}


\item Store Buffers
\label{sec:orgebc39f5}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:orgd716de0}


\section{Memory Barriers}
\label{sec:org3f943ff}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:orge1ec735}


\item Memory Fences
\label{sec:org2e0d40e}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:orgb27c468}


\section{Bibliography}
\label{sec:org3d9d826}
...
\label{sec:org125d7fb}

\chapter{Introduction}
\label{sec:orgf968b8a}
...
\part{Work-stealing}
\label{sec:orgfc8c028}




\part{Modular Basket Queues}
\label{sec:org0facecb}

\chapter{Measuring Performance}
\label{sec:org1883363}
...
\label{sec:org76b4df1}

\chapter{Concurrent computing}
\label{sec:org51cf5a2}

\section{Work-Stealing}
\label{sec:org8edb229}

\section{Article}
\label{sec:org251096f}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:orge021ee0}

\begin{enumerate}
\item Experiments C++
\label{sec:orgfe1821d}
\begin{enumerate}
\item What to use?
\label{sec:org1c151cc}
...
\item Model
\label{sec:org84ec242}

\item Technology to use
\label{sec:orgf465a12}
...
\section{Links}
\label{sec:orgfa64192}
\begin{enumerate}
\item Philosophy
\label{sec:org996aa08}
...
\label{sec:orgcd55454}
\begin{enumerate}
\item C/C++/Java
\label{sec:org1aeab65}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org8a6df25}

\section{Git}
\label{sec:org4fadcc9}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org0751a6c}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org61ea088}

\section{Temario tentativo}
\label{sec:orgf0383ed}
...
\label{sec:org6a8627d}

\begin{enumerate}
\item Diseño experimental
\label{sec:org0613f59}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:orgc847094}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:orgac7a3cd}
...
\label{sec:org816cbae}


\begin{enumerate}
\item Data Science
\label{sec:orgeb3ee66}
...
\label{sec:org9061d52}

\item Main Concepts
\label{sec:org35c373d}

\item Match Between Statistic and Data Science
\label{sec:org758bff5}
\end{enumerate}
...
\label{sec:org7a70524}
\begin{enumerate}
\item Main ideas
\label{sec:org48e353d}
