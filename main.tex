...
\label{sec:org1c18629}

\section{About Concurrent Computing}
\label{sec:org9fa0590}
...
\label{sec:orgf76235a}

\subsection{Organization}
\label{sec:orge9ab001}


\section{Preliminaries}
\label{sec:orgb5884d0}


\subsection{Mathematical model}
\label{sec:orgdf81cb5}


\subsection{Realistic model of computation}
\label{sec:orgb7adb2f}
...
the sections: \hyperref[sec:org7950b30]{Cache memory}, \hyperref[sec:org03295e2]{Memory bus} and \hyperref[sec:orgec12523]{Main memory}, we explain more in
...
\label{sec:orgd3dd183}

\begin{enumerate}
\item Consistency memory model
\label{sec:org9bfe8dd}
...
\subsection{Model}
\label{sec:org5784492}

\subsection{Known algorithms}
\label{sec:org4db47e3}

\subsection{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orgdae8060}



\section{Data-Structures}
\label{sec:org12a5c84}

\subsection{Queues}
\label{sec:org8954479}

\subsection{Stacks}
\label{sec:org31b9d84}


\section{Some Hardware Foundations}
\label{sec:orgda6ec77}

\subsection{Cache memory}
\label{sec:org8636ddb}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org8b1aab7}


\item Cache coherence protocols
\label{sec:org2d7f3ed}



\begin{enumerate}
\item MESI
\label{sec:orgca3a122}


\item MOESI
\label{sec:orgc96470f}
\end{enumerate}


\item Store Buffers
\label{sec:org1998197}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:org5d510e2}


\subsection{Memory Barriers}
\label{sec:orgee8b473}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org3adb5f2}


\item Memory Fences
\label{sec:orgb5a7e1c}
\end{enumerate}


\subsection{Read-Modify-Write Operations}
\label{sec:org55ddfcb}


\subsection{Bibliography}
\label{sec:orga050bcc}
...
\label{sec:orgdd6286d}

\section{Introduction}
\label{sec:org348a430}
...
\label{sec:orgd37c854}

\chapter{Modular Basket Queues}
\label{sec:org6197a97}

\section{Measuring Performance}
\label{sec:orgb873c98}

\subsection{Introduction}
\label{sec:orgb8cb24a}
...
\label{sec:org7368c94}


\section{Clojure for data-science}
\label{sec:orga79115b}
...
\chapter{Other links}
\label{sec:org09b32d0}

\section{Youtube videos}
\label{sec:org9c2dc71}
...
\chapter{Notes}
\label{sec:orgd9fcd7c}

\section{Concurrent computing}
\label{sec:orgfe5a6d5}

\subsection{Work-Stealing}
\label{sec:org7213690}

\subsection{Article}
\label{sec:org9fc23d8}

\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org094b1f9}

\begin{enumerate}
\item Experiments C++
\label{sec:org5b0f340}

\begin{enumerate}
\item What to use?
\label{sec:org0459e23}
...
\item Model
\label{sec:orgee404ef}

\item Technology to use
\label{sec:org72ec0e1}
...
\subsection{Links}
\label{sec:org8cec1fe}
\begin{enumerate}
\item Philosophy
\label{sec:org11b53c0}
...
\label{sec:orgfde0514}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgf547550}
\begin{itemize}
...
\section{Notes}
\label{sec:orgec3ec4e}

\subsection{Git}
\label{sec:org3d01b3a}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org675c6ce}
\begin{itemize}
...
\section{Statistics}
\label{sec:org47e7ea1}

\subsection{Temario tentativo}
\label{sec:org09c8d45}
...
\label{sec:org2c63863}

\begin{enumerate}
\item Diseño experimental
\label{sec:org1bbb947}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:orgaee23f1}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org9bed8ac}
...
\label{sec:org7ae0c73}


\begin{enumerate}
\item Data Science
\label{sec:org415189e}
...
\label{sec:orgf67949b}

\item Main Concepts
\label{sec:org218883c}

\item Match Between Statistic and Data Science
\label{sec:orgc3441b3}
\end{enumerate}
...
\label{sec:org4d3ca14}
\begin{enumerate}
\item Main ideas
\label{sec:orgbbd6a87}
