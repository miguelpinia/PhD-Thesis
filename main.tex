...
\part{Introduction}
\label{sec:org3a7d6f9}

\chapter{About Concurrent Computing}
\label{sec:org4c2c497}
...
\label{sec:org2a08f3f}

\section{Organization}
\label{sec:orgcb095d9}

\chapter{Preliminaries}
\label{sec:org83da480}


\section{Mathematical model}
\label{sec:orgfa51c6f}
...
the sections: \hyperref[sec:org6fdb81f]{Cache memory}, \hyperref[sec:orga5109c4]{Memory bus} and \hyperref[sec:org8948cba]{Main memory}, we explain more in
...
\label{sec:org7e4339e}

\begin{enumerate}
\item Consistency memory model
\label{sec:org6128d02}
...
\section{Model}
\label{sec:orgfd07a2e}

\section{Known algorithms}
\label{sec:org6fa3272}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:org323a961}



\chapter{Data-Structures}
\label{sec:org42ab1c1}

\section{Queues}
\label{sec:orge53e961}

\section{Stacks}
\label{sec:orged4a803}

\chapter{Some Hardware Foundations}
\label{sec:org943ba20}

\section{Cache memory}
\label{sec:orgcf3ad5b}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org7c5d5ea}


\item Cache coherence protocols
\label{sec:orgc4d47a9}



\begin{enumerate}
\item MESI
\label{sec:orgd4e16ea}


\item MOESI
\label{sec:orgfa465bb}
\end{enumerate}


\item Store Buffers
\label{sec:org3b0dbaf}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:org07329c9}


\section{Memory Barriers}
\label{sec:orga682f54}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org7c6d385}


\item Memory Fences
\label{sec:org575b61e}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org2f77732}


\section{Bibliography}
\label{sec:org3f82f9c}
...
\label{sec:orgcf6f2a1}

\chapter{Introduction}
\label{sec:org2511fec}
...
\part{Work-stealing}
\label{sec:orga93fe8f}




\part{Modular Basket Queues}
\label{sec:orgbfa09ea}

\chapter{Measuring Performance}
\label{sec:orga8d5477}
...
\label{sec:org34a2f2c}

\chapter{Concurrent computing}
\label{sec:orgfa37def}

\section{Work-Stealing}
\label{sec:org121167f}

\section{Article}
\label{sec:org4849372}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:orgd26b5ca}

\begin{enumerate}
\item Experiments C++
\label{sec:org06eff18}
\begin{enumerate}
\item What to use?
\label{sec:orga5b97c0}
...
\item Model
\label{sec:org2a75973}

\item Technology to use
\label{sec:org57edd06}
...
\section{Links}
\label{sec:orga6e2287}
\begin{enumerate}
\item Philosophy
\label{sec:org53b8ca6}
...
\label{sec:org596b611}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgcec4c01}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org8b6a21e}

\section{Git}
\label{sec:org392539c}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org04c142c}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org24d7bfc}

\section{Temario tentativo}
\label{sec:org1b03c00}
...
\label{sec:org97f94cf}

\begin{enumerate}
\item Diseño experimental
\label{sec:org2bb8a91}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org4c6c46c}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:orgdc1b1a2}
...
\label{sec:orga74f49a}


\begin{enumerate}
\item Data Science
\label{sec:orgc79bd8f}
...
\label{sec:org256b6ae}

\item Main Concepts
\label{sec:org5b01f4f}

\item Match Between Statistic and Data Science
\label{sec:org656bb77}
\end{enumerate}
...
\label{sec:org39ca692}
\begin{enumerate}
\item Main ideas
\label{sec:org547a4fa}
