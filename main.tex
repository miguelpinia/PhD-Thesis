...
\label{sec:org9e41bb0}

\section{Organization}
\label{sec:org297ae48}

\chapter{Preliminaries}
\label{sec:orgfcdcd39}
...
\section{Model}
\label{sec:orgff84f47}

\section{Known algorithms}
\label{sec:org355945e}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orgcc6b8ea}



\chapter{Data-Structures}
\label{sec:org88acc40}

\section{Queues}
\label{sec:org3d5487c}

\section{Stacks}
\label{sec:org1bf94e9}

\chapter{Some Hardware Foundations}
\label{sec:orgc36dae3}

\section{Cache memory}
\label{sec:org0930976}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orge8eb673}


\item Cache coherence protocols
\label{sec:org5898dd4}



\begin{enumerate}
\item MESI
\label{sec:org6b99b87}


\item MOESI
\label{sec:orgd34b576}
\end{enumerate}


\item Store Buffers
\label{sec:org5093d5f}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:orgc3c0e53}


\section{Memory Barriers}
\label{sec:orga2cce0e}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:orgd8627f9}


\item Memory Fences
\label{sec:org43c224c}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:orgf207e0a}


\section{Bibliography}
\label{sec:org34da8ae}
...
\label{sec:org3425301}

\chapter{Introduction}
\label{sec:orga5ac23b}
...
\label{sec:org79dda47}

\chapter{Concurrent computing}
\label{sec:org9e7966e}

\section{Work-Stealing}
\label{sec:org02ace50}

\section{Article}
\label{sec:org02c391e}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org04d58f2}

\begin{enumerate}
\item Experiments C++
\label{sec:org200f156}
\begin{enumerate}
\item What to use?
\label{sec:orgd2cd474}
...
\item Model
\label{sec:org62390f5}

\item Technology to use
\label{sec:org12c7371}
...
\section{Links}
\label{sec:orgb4bd4ec}
\begin{enumerate}
\item Philosophy
\label{sec:orgc28d337}
...
\label{sec:org471a256}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgb4cc902}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org5f8f55f}

\section{Git}
\label{sec:org2dfd40b}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org5eea5b1}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org9468937}

\section{Temario tentativo}
\label{sec:org170a604}
...
\label{sec:org245bd19}

\begin{enumerate}
\item Diseño experimental
\label{sec:orgb443d8d}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org8c28e60}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org8dd4a64}
...
\label{sec:orgd591849}


\begin{enumerate}
\item Data Science
\label{sec:orgc24d097}
...
\label{sec:org10d9b33}

\item Main Concepts
\label{sec:orgbef61be}

\item Match Between Statistic and Data Science
\label{sec:org3fca40f}
\end{enumerate}
