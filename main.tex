...
\lstset{ basicstyle=\footnotesize\mdseries\ttfamily, mathescape=true, frame=Trbl, numbers=left, keywordstyle=\color{blue}, showstringspaces=false, commentstyle=\color{x11gray}, stringstyle=\color{amber}, breakline=true}
...
\label{sec:org3b24ed9}

\section{About Concurrent Computing}
\label{sec:orgbffe9b2}
...
\label{sec:orgb467ca8}

\subsection{Organization}
\label{sec:org70721cb}


\section{Preliminaries}
\label{sec:orgbbbcbd1}


\subsection{Mathematical model}
\label{sec:orgd9e1324}


\subsection{Realistic model of computation}
\label{sec:org107922f}
...
the sections: \hyperref[sec:org4b68861]{Cache memory}, \hyperref[sec:orgdc7d102]{Memory bus} and \hyperref[sec:org4682745]{Main memory}, we explain more in
...
\subsection{Model}
\label{sec:org94f70b6}

\subsection{Known algorithms}
\label{sec:org2fbf810}

\subsection{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orgb96b659}



\section{Data-Structures}
\label{sec:org3adf7cf}

\subsection{Queues}
\label{sec:org8939da0}

\subsection{Stacks}
\label{sec:org658ecc3}


\section{Some Hardware Foundations}
\label{sec:org8d1ae39}

\subsection{Cache memory}
\label{sec:orgc3b42f2}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orgf080e0a}


\item Cache coherence protocols
\label{sec:org9bb40cf}



\begin{enumerate}
\item MESI
\label{sec:orgc746723}


\item MOESI
\label{sec:org405ea60}
\end{enumerate}


\item Store Buffers
\label{sec:org2711240}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:orgc990763}


\subsection{Memory Barriers}
\label{sec:orgc26da29}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org4aca42c}


\item Memory Fences
\label{sec:org4201344}
\end{enumerate}


\subsection{Read-Modify-Write Operations}
\label{sec:org3a50d45}


\subsection{Bibliography}
\label{sec:org3c95385}
...
\label{sec:org16388b3}

\section{Introduction}
\label{sec:org2a47f30}
...
\label{sec:org07b2ec2}


\chapter{Modular Basket Queues}
\label{sec:org16620e4}

\section{Measuring Performance}
\label{sec:org30c6ffe}

\subsection{Introduction}
\label{sec:org3789073}
...
\label{sec:org447ac46}


\section{Clojure for data-science}
\label{sec:orgbec9e06}
...
\label{sec:org1ede13a}

\section{1.1 Threads}
\label{sec:org52622cc}
...
\chapter{Other links}
\label{sec:orgf343086}

\section{Youtube videos}
\label{sec:orgc63f2fc}
...
\chapter{Notes}
\label{sec:org58f2daf}

\section{Concurrent computing}
\label{sec:org33e7518}

\subsection{Work-Stealing}
\label{sec:orgf883442}

\subsection{Article}
\label{sec:org990dcf6}

\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org33ff5f0}

\begin{enumerate}
\item Experiments C++
\label{sec:org0c5154e}

\begin{enumerate}
\item What to use?
\label{sec:org35773e7}
...
\item Model
\label{sec:orgf179c9d}

\item Technology to use
\label{sec:orgb805172}
...
\subsection{Links}
\label{sec:orgd3fcca2}
\begin{enumerate}
\item Philosophy
\label{sec:orgc1855ce}
...
\label{sec:orgf774dfd}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgd6baa78}
\begin{itemize}
...
\section{Notes}
\label{sec:org009c1ed}

\subsection{Git}
\label{sec:org65f5138}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:orgdc4af7c}
\begin{itemize}
...
\section{Statistics}
\label{sec:org14cb7d9}

\subsection{Temario tentativo}
\label{sec:orgbdf306e}
...
\label{sec:org6f0e8c9}

\begin{enumerate}
\item Diseño experimental
\label{sec:org3f9ed3a}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:orgab7b68f}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org2f7d511}
...
\label{sec:org7bd69dd}


\begin{enumerate}
\item Data Science
\label{sec:orgab3a0ed}
...
\label{sec:org276f3c4}

\item Main Concepts
\label{sec:orgdadef59}

\item Match Between Statistic and Data Science
\label{sec:orgc252cbd}
\end{enumerate}
...
\label{sec:org9cf868e}
\begin{enumerate}
\item Main ideas
\label{sec:org3d6a20f}
