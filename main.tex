...
\label{sec:org92b9aee}


\section{Memory Barriers}
\label{sec:org1851835}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org47d0377}


\item Memory Fences
\label{sec:orgcea63ab}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org5f4dd5a}


\section{Bibliography}
\label{sec:orgeb506aa}
...
\label{sec:orgc5d0fcc}

\chapter{Introduction}
\label{sec:orgc6caf70}
...
\label{sec:org7b255a8}

\chapter{Concurrent computing}
\label{sec:orgb255929}

\section{Work-Stealing}
\label{sec:orgaa01aa4}

\section{Article}
\label{sec:orgb0b6792}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:orgcf0482c}

\begin{enumerate}
\item Experiments C++
\label{sec:orge72d9b4}
\begin{enumerate}
\item What to use?
\label{sec:orgd4d8dee}
...
\item Model
\label{sec:org6261c7a}

\item Technology to use
\label{sec:org64fcd47}
...
\section{Links}
\label{sec:orgcbb08b5}
\begin{enumerate}
\item Philosophy
\label{sec:org2f182ef}
...
\label{sec:orgb9014ef}
\begin{enumerate}
\item C/C++/Java
\label{sec:org69d12f4}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org0e6a46d}

\section{Git}
\label{sec:orgb8272f6}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org3e51ab1}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:orgfe45703}

\section{Temario tentativo}
\label{sec:orga1090d5}
...
\label{sec:org43dcb7b}

\begin{enumerate}
\item Diseño experimental
\label{sec:org5392b8a}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:orgead45f2}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org4fddfbd}
...
\label{sec:org9b9e799}


\begin{enumerate}
\item Data Science
\label{sec:org1de7bf2}
...
\label{sec:org43a6c8b}

\item Main Concepts
\label{sec:org4ff18fc}

\item Match Between Statistic and Data Science
\label{sec:org91e6986}
\end{enumerate}
