...
the sections: \hyperref[sec:org40e3302]{Cache memory}, \hyperref[sec:orgd4dd69c]{Memory bus} and \hyperref[sec:org571c541]{Main memory}, we explain more in
...
\label{sec:orgaf164a7}

\begin{enumerate}
\item Consistency memory model
\label{sec:org5bc9e4d}
...
\section{{\bfseries\sffamily TODO} Data-Structures}
\label{sec:org16ffdcc}

\subsection{Queues}
\label{sec:org3f8f11d}

\subsection{Stacks}
\label{sec:orge69962d}


\section{{\bfseries\sffamily TODO} Some Hardware Foundations}
\label{sec:org007e85a}

\subsection{Cache memory}
\label{sec:org3837496}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orge82c373}


\item Cache coherence protocols
\label{sec:orgc410ca1}



\begin{enumerate}
\item MESI
\label{sec:orgeffc0ea}


\item MOESI
\label{sec:org099164b}
\end{enumerate}


\item Store Buffers
\label{sec:org5feb570}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:orgc1322a8}

\subsection{Memory Barriers}
\label{sec:org9cf87b9}

\begin{enumerate}
\item X86 and TSO architectures
\label{sec:orgc0ea3e6}

\item Memory Fences
\label{sec:org293e677}
\end{enumerate}

\subsection{Read-Modify-Write Operations}
\label{sec:org7bf6f7b}

\subsection{Bibliography}
\label{sec:org36b5e75}
