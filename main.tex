...
\part{Introduction}
\label{sec:orga63c284}

\chapter{About Concurrent Computing}
\label{sec:org9bef255}
...
\label{sec:orgae34931}

\section{Organization}
\label{sec:orga3b8034}

\chapter{Preliminaries}
\label{sec:org3ecc65a}


\section{Mathematical model}
\label{sec:org031486c}


\section{Realistic model of computation}
\label{sec:orgf542cae}
...
the sections: \hyperref[sec:org2794c6d]{Cache memory}, \hyperref[sec:org3969075]{Memory bus} and \hyperref[sec:org697dc62]{Main memory}, we explain more in
...
\label{sec:orgbc5774b}

\begin{enumerate}
\item Consistency memory model
\label{sec:org2ecffe2}
...
\section{Model}
\label{sec:orga097f56}

\section{Known algorithms}
\label{sec:org7f49feb}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:org473d4c3}



\chapter{Data-Structures}
\label{sec:org691b605}

\section{Queues}
\label{sec:org7d59513}

\section{Stacks}
\label{sec:orgcbdd154}

\chapter{Some Hardware Foundations}
\label{sec:orgf20d567}

\section{Cache memory}
\label{sec:orgceab43d}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orge92b070}


\item Cache coherence protocols
\label{sec:orgc652bde}



\begin{enumerate}
\item MESI
\label{sec:orgf44ac5d}


\item MOESI
\label{sec:org8c89950}
\end{enumerate}


\item Store Buffers
\label{sec:org1d96fbe}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:orgce3e761}


\section{Memory Barriers}
\label{sec:org90a81bf}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org0f94cf4}


\item Memory Fences
\label{sec:org412ef38}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org98a6152}


\section{Bibliography}
\label{sec:org0ad1400}
...
\label{sec:orgb74a515}

\chapter{Introduction}
\label{sec:orgaf646a9}
...
\label{sec:org7f1e18d}


\part{Other links}
\label{sec:org107749a}

\chapter{Youtube videos}
\label{sec:org2de72af}
...
\label{sec:orgcbba093}

\chapter{Concurrent computing}
\label{sec:orgbe79ae9}

\section{Work-Stealing}
\label{sec:org1a6c253}

\section{Article}
\label{sec:org1640161}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org0d4be1d}

\begin{enumerate}
\item Experiments C++
\label{sec:orgdf30c7d}
\begin{enumerate}
\item What to use?
\label{sec:orgf2547c5}
...
\item Model
\label{sec:org7dd138c}

\item Technology to use
\label{sec:org30a3cef}
...
\section{Links}
\label{sec:orgf47223a}
\begin{enumerate}
\item Philosophy
\label{sec:org8b0b15e}
...
\label{sec:org28773d4}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgcb30d80}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org597b673}

\section{Git}
\label{sec:org9ec501c}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org44d6eb5}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:orgd9e0f08}

\section{Temario tentativo}
\label{sec:org505596d}
...
\label{sec:org9d82be6}

\begin{enumerate}
\item Diseño experimental
\label{sec:orgb50376a}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org8b742b8}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:orgb995d3a}
...
\label{sec:orgd417f26}


\begin{enumerate}
\item Data Science
\label{sec:org56e99bc}
...
\label{sec:orgb7464f1}

\item Main Concepts
\label{sec:orgf69831c}

\item Match Between Statistic and Data Science
\label{sec:org41816d5}
\end{enumerate}
...
\label{sec:org1161cdb}
\begin{enumerate}
\item Main ideas
\label{sec:org039e499}
