...
\part{Introduction}
\label{sec:org7727842}

\chapter{About Concurrent Computing}
\label{sec:orgd859a97}
...
\label{sec:orgf936565}

\section{Organization}
\label{sec:orgd06dc3f}

\chapter{Preliminaries}
\label{sec:org3e378b0}


\section{Mathematical model}
\label{sec:orgeb177d5}


\section{Realistic model of computation}
\label{sec:orgbe76d57}
...
the sections: \hyperref[sec:orga58e7fb]{Cache memory}, \hyperref[sec:org7fd3270]{Memory bus} and \hyperref[sec:orgaf9f25c]{Main memory}, we explain more in
...
\label{sec:orge72ca8c}

\begin{enumerate}
\item Consistency memory model
\label{sec:org7528e4d}
...
\section{Model}
\label{sec:orgb0f5ce9}

\section{Known algorithms}
\label{sec:orgd420ef1}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:org195d0f7}



\chapter{Data-Structures}
\label{sec:org0f14256}

\section{Queues}
\label{sec:org7219d27}

\section{Stacks}
\label{sec:org57397c8}

\chapter{Some Hardware Foundations}
\label{sec:orgf432d99}

\section{Cache memory}
\label{sec:orgd8b86d4}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:orgb620ea1}


\item Cache coherence protocols
\label{sec:org037fccf}



\begin{enumerate}
\item MESI
\label{sec:org000e82c}


\item MOESI
\label{sec:org6293a79}
\end{enumerate}


\item Store Buffers
\label{sec:org44ce39c}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:orgec40c74}


\section{Memory Barriers}
\label{sec:org6a1168e}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org6f29976}


\item Memory Fences
\label{sec:org13329fa}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org264e321}


\section{Bibliography}
\label{sec:orgca2a088}
...
\label{sec:org3f2446d}

\chapter{Introduction}
\label{sec:org650a454}
...
\part{Work-stealing}
\label{sec:org1e127bb}

\part{Modular Basket Queues}
\label{sec:org41d9c2f}

\chapter{Modular Basket Queues}
\label{sec:org6e2c60a}
...
\label{sec:orgc6de283}



\part{Other links}
\label{sec:orga39ee74}

\chapter{Youtube videos}
\label{sec:orga6cc3d1}
...
\label{sec:org7a053a0}

\chapter{Concurrent computing}
\label{sec:org33933a8}

\section{Work-Stealing}
\label{sec:org42a4ed5}

\section{Article}
\label{sec:orgae88112}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org453ea62}

\begin{enumerate}
\item Experiments C++
\label{sec:org0f0c6f4}
\begin{enumerate}
\item What to use?
\label{sec:org9a0c69e}
...
\item Model
\label{sec:orgdbd7bb2}

\item Technology to use
\label{sec:org469469f}
...
\section{Links}
\label{sec:org73b83e0}
\begin{enumerate}
\item Philosophy
\label{sec:org5ed7190}
...
\label{sec:orgc7ea21a}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgd8f1611}
\begin{itemize}
...
\chapter{Notes}
\label{sec:orgefbf7e9}

\section{Git}
\label{sec:orgfac80b8}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:orga53eef4}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:orged65d39}

\section{Temario tentativo}
\label{sec:org91671e4}
...
\label{sec:orgf5d1cf3}

\begin{enumerate}
\item Diseño experimental
\label{sec:org0209e28}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org843820f}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org8a16df4}
...
\label{sec:org15783cb}


\begin{enumerate}
\item Data Science
\label{sec:org1e97a62}
...
\label{sec:org30bd99d}

\item Main Concepts
\label{sec:orgbbb86ba}

\item Match Between Statistic and Data Science
\label{sec:orgd1655d4}
\end{enumerate}
...
\label{sec:org5dd2e1f}
\begin{enumerate}
\item Main ideas
\label{sec:orgd7f4115}
