...
\label{sec:org5c513e7}

\section{About Concurrent Computing}
\label{sec:org977f0d9}
...
\label{sec:org9fad619}

\subsection{Organization}
\label{sec:orgca8b6c2}


\section{Preliminaries}
\label{sec:org01fea38}


\subsection{Mathematical model}
\label{sec:orgf731aff}


\subsection{Realistic model of computation}
\label{sec:org808f623}
...
the sections: \hyperref[sec:org7d46b02]{Cache memory}, \hyperref[sec:orgadef312]{Memory bus} and \hyperref[sec:org780831b]{Main memory}, we explain more in
...
\label{sec:org7ddf48f}

\begin{enumerate}
\item Consistency memory model
\label{sec:org61555c8}
...
\subsection{Model}
\label{sec:org4f91ff7}

\subsection{Known algorithms}
\label{sec:org5fc5843}

\subsection{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:orge9122d9}



\section{Data-Structures}
\label{sec:org54c113a}

\subsection{Queues}
\label{sec:orgd53389a}

\subsection{Stacks}
\label{sec:org33ac613}


\section{Some Hardware Foundations}
\label{sec:org79f4bbd}

\subsection{Cache memory}
\label{sec:orge788d24}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org606f0bb}


\item Cache coherence protocols
\label{sec:org7656624}



\begin{enumerate}
\item MESI
\label{sec:orgcb73707}


\item MOESI
\label{sec:org2b1e3e7}
\end{enumerate}


\item Store Buffers
\label{sec:org8a9ec9f}
\end{enumerate}


\subsection{Reordering (CPU or Compiler)}
\label{sec:orgb9c512e}


\subsection{Memory Barriers}
\label{sec:orgbd0e7e1}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org2e09115}


\item Memory Fences
\label{sec:orge5ef91b}
\end{enumerate}


\subsection{Read-Modify-Write Operations}
\label{sec:org4f09b92}


\subsection{Bibliography}
\label{sec:org5dbae73}
...
\label{sec:orgd05e129}

\section{Introduction}
\label{sec:orgfe0a07b}
...
\label{sec:orga98dfbe}

\chapter{Modular Basket Queues}
\label{sec:orgfa280e1}

\section{Measuring Performance}
\label{sec:orge297d96}

\subsection{Introduction}
\label{sec:orge821960}
...
\label{sec:orge5a09ce}


\section{Clojure for data-science}
\label{sec:org5a043ff}
...
class MyThread implements Runnable {
    ...
    public MyThread(String threadName) {
        ...
        System.out.println(String.format("New Thread: %s", t.toString()));
        exit = false;
...
\chapter{Notes}
\label{sec:orga16a8ca}

\section{Concurrent computing}
\label{sec:org72dc29d}

\subsection{Work-Stealing}
\label{sec:org2dcdcf2}

\subsection{Article}
\label{sec:orge4cb2de}

\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org7d06e92}

\begin{enumerate}
\item Experiments C++
\label{sec:org4db1c6a}

\begin{enumerate}
\item What to use?
\label{sec:org4f0965a}
...
\item Model
\label{sec:org951b89e}

\item Technology to use
\label{sec:orgd4ca261}
...
\subsection{Links}
\label{sec:org7760d88}
\begin{enumerate}
\item Philosophy
\label{sec:org967169d}
...
\label{sec:org173bd6e}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgdc69974}
\begin{itemize}
...
\section{Notes}
\label{sec:orgff77eda}

\subsection{Git}
\label{sec:org0ac935d}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org821b849}
\begin{itemize}
...
\label{sec:orgbfbec86}

\begin{enumerate}
\item Diseño experimental
\label{sec:org92f6ed4}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org322c467}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org9f77f0d}
...
\label{sec:org12829a4}


\begin{enumerate}
\item Data Science
\label{sec:org94efbc3}
...
\label{sec:org4f01882}

\item Main Concepts
\label{sec:org673fd92}

\item Match Between Statistic and Data Science
\label{sec:org3bbaa78}
\end{enumerate}
...
\label{sec:orgbde8123}
\begin{enumerate}
\item Main ideas
\label{sec:org3e4bddc}
