...
\part{Introduction}
\label{sec:org113a1b9}

\chapter{About Concurrent Computing}
\label{sec:orgf8b4e89}
...
\label{sec:orgdb21b9b}

\section{Organization}
\label{sec:org7bf3a0c}

\chapter{Preliminaries}
\label{sec:org9d88444}


\section{Mathematical model}
\label{sec:org9e18ecd}


\section{Realistic model of computation}
\label{sec:orgf32937a}
...
the sections: \hyperref[sec:orgfbc9f30]{Cache memory}, \hyperref[sec:org5ea0c9c]{Memory bus} and \hyperref[sec:org4ff7baa]{Main memory}, we explain more in
...
\label{sec:org7c22846}

\begin{enumerate}
\item Consistency memory model
\label{sec:org06a5809}
...
\section{Model}
\label{sec:org1f94c6e}

\section{Known algorithms}
\label{sec:orgbafaaa9}

\section{Pseudocode for Work-Stealing with Weak Multiplicity}
\label{sec:org5aeb319}



\chapter{Data-Structures}
\label{sec:orgfdf862c}

\section{Queues}
\label{sec:org534fb89}

\section{Stacks}
\label{sec:org65d3d26}

\chapter{Some Hardware Foundations}
\label{sec:org4d69617}

\section{Cache memory}
\label{sec:org5345ba1}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org83c1c73}


\item Cache coherence protocols
\label{sec:org3abe57f}



\begin{enumerate}
\item MESI
\label{sec:org3fc947d}


\item MOESI
\label{sec:orgb80a6ec}
\end{enumerate}


\item Store Buffers
\label{sec:orgd331247}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:org1c51c37}


\section{Memory Barriers}
\label{sec:org6a4e22b}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:org8e05665}


\item Memory Fences
\label{sec:org0ab5b7a}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:orga45c737}


\section{Bibliography}
\label{sec:orgb68d150}
...
\label{sec:orga189497}

\chapter{Introduction}
\label{sec:orgd439752}
...
measured. The null hypothesis

\chapter{Modular Basket Queues}
\label{sec:org5a946b6}
...
\label{sec:org3746c02}


\part{Other links}
\label{sec:orgf2afb44}

\chapter{Youtube videos}
\label{sec:org5df528d}
...
\label{sec:org4f91b8c}

\chapter{Concurrent computing}
\label{sec:orge06010b}

\section{Work-Stealing}
\label{sec:orga28604e}

\section{Article}
\label{sec:orgf2ff59e}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:org364c662}

\begin{enumerate}
\item Experiments C++
\label{sec:org3201be9}
\begin{enumerate}
\item What to use?
\label{sec:org85747a8}
...
\item Model
\label{sec:org70fbb8e}

\item Technology to use
\label{sec:org3131d6d}
...
\section{Links}
\label{sec:org7937cd7}
\begin{enumerate}
\item Philosophy
\label{sec:org9351e91}
...
\label{sec:org30d8b9d}
\begin{enumerate}
\item C/C++/Java
\label{sec:orgc8a5fc0}
\begin{itemize}
...
\chapter{Notes}
\label{sec:org9fd471b}

\section{Git}
\label{sec:org2ddde76}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:org1e4efdd}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org8c1b147}

\section{Temario tentativo}
\label{sec:org06fc834}
...
\label{sec:org9e4c811}

\begin{enumerate}
\item Diseño experimental
\label{sec:org148209f}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org171d19b}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org018a3d4}
...
\label{sec:orgbba4167}


\begin{enumerate}
\item Data Science
\label{sec:org10b8ee0}
...
\label{sec:org72605c2}

\item Main Concepts
\label{sec:orgd6979be}

\item Match Between Statistic and Data Science
\label{sec:orgf75855b}
\end{enumerate}
...
\label{sec:org5f53469}
\begin{enumerate}
\item Main ideas
\label{sec:org81cd4b3}
