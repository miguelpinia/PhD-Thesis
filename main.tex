...
the sections: \hyperref[sec:org4af340d]{Cache memory}, \hyperref[sec:org90151ce]{Memory bus} and \hyperref[sec:orgb5be700]{Main memory}, we explain more in
...
\label{sec:org69f0fb5}

\begin{enumerate}
\item Consistency memory model
\label{sec:org860ec50}
...
\label{sec:orgb9c78c6}



\chapter{Some Foundations}
\label{sec:orga9171d5}

\section{Cache memory}
\label{sec:orge924bd8}

The cache memory

\begin{enumerate}
\item Multiple caches
\label{sec:org21927f0}


\item Cache coherence protocols
\label{sec:org1f88786}



\begin{enumerate}
\item MESI
\label{sec:org30b7b14}


\item MOESI
\label{sec:org4dac102}
\end{enumerate}


\item Store Buffers
\label{sec:org84caf71}
\end{enumerate}


\section{Reordering (CPU or Compiler)}
\label{sec:orge9b96d7}


\section{Memory Barriers}
\label{sec:orgcd58b36}


\begin{enumerate}
\item X86 and TSO architectures
\label{sec:orgd04271f}


\item Memory Fences
\label{sec:org51dc204}
\end{enumerate}


\section{Read-Modify-Write Operations}
\label{sec:org4408eb9}


\section{Bibliography}
\label{sec:org541563a}
...
\label{sec:org0c4021f}

\chapter{Introduction}
\label{sec:orgdd5e446}
...
\part{Other links}
\label{sec:org06751ac}

\chapter{Youtube videos}
\label{sec:orgf2bde1a}
...
\label{sec:org57037b9}

\chapter{Concurrent computing}
\label{sec:org8e35baf}

\section{Work-Stealing}
\label{sec:org7bdbb8f}

\section{Article}
\label{sec:orgc4b0a4c}
\begin{enumerate}
\item Work-stealing with multiplicity
\label{sec:orgce5ca3c}

\begin{enumerate}
\item Experiments C++
\label{sec:orgf1c9f4a}
\begin{enumerate}
\item What to use?
\label{sec:orgcb59751}
...
\section{Links}
\label{sec:orgabe1894}
\begin{enumerate}
\item Philosophy
\label{sec:org25eabae}
...
\label{sec:org846df6d}
\begin{enumerate}
\item C/C++/Java
\label{sec:org6957e31}
\begin{itemize}
...
\chapter{Notes}
\label{sec:orgdd01b5d}

\section{Git}
\label{sec:orgb946df1}
\begin{enumerate}
\item Write git messages that your colleagues will love
\label{sec:orgdaf4ffa}
\begin{itemize}
...
\chapter{Statistics}
\label{sec:org7423039}

\section{Temario tentativo}
\label{sec:org105bb2f}
...
\label{sec:org41ff1b2}

\begin{enumerate}
\item Diseño experimental
\label{sec:org851f29e}
\begin{itemize}
...
\item Pruebas estadísticas
\label{sec:org9d2a3f8}

\begin{enumerate}
\item Pruebas para dos grupos (muestras)
\label{sec:org2f3aaa5}
...
\label{sec:orga3eea7c}


\begin{enumerate}
\item Data Science
\label{sec:orgb0b34cb}
...
\label{sec:orga0411df}

\item Main Concepts
\label{sec:orgef70be0}

\item Match Between Statistic and Data Science
\label{sec:orgc399655}
\end{enumerate}
