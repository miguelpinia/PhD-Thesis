...
\begin{enumerate}
    \item Each process first invokes an operation, and only when it has a corresponding response it can invoke another operation, i.e., executions are well-formed, and
