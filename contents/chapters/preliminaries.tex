...
TSO behaves similarly to Sequential Consistency, permitting only one type of reordering. Hence, fences are fairly infrequently used, and their implementation is not too critical. For consistency models that permit far more reordering, fences are more frequent, and their implementation can significantly impact performance.
