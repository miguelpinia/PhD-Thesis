...
The outcome of the Enqueue - Dequeue Outer Experiment for 64 processes appears in Figure~\ref{fig:64-inner-enq-deq}, with their respective dataset in Table~\ref{table:64-inner-enq-deq-times} and their respective percentage improvement shown in Table~\ref{table:64-inner-enq-deq-percentages}.
...
The outcome of the Enqueue - Dequeue Outer Experiment for 64 processes appears in Figure~\ref{fig:64-outer--enq-deq}, with their respective dataset in Table~\ref{table:64-outer-enq-deq-times} and their respective percentage improvement shown in Table~\ref{table:64-outer-enq-deq-percentages}.
